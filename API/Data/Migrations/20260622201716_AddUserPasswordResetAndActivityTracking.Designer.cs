...
namespace API.Data.Migrations
{
    ...
    [Migration("20260622201716_AddUserPasswordResetAndActivityTracking")]
    partial class AddUserPasswordResetAndActivityTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Data.Entities.MontageAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("MontageId")
                        .HasDatabaseName("idx_montage_assignments_montage_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("idx_montage_assignments_user_id");

                    b.HasIndex("MontageId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("idx_montage_assignments_montage_user_unique");

                    b.ToTable("montage_assignments");
                });
